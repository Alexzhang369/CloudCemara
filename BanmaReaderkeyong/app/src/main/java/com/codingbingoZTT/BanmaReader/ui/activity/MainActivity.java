...
public class MainActivity extends BaseActivity implements
    ...
    private void initView() {
        ...
        TTSyule = (LinearLayout) menuView.findViewById(R.id.TTSyule);
    ...
    private void initViewListener() {
        ...
        TTSyule.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.feedback:
                break;
            case R.id.TTSyule:
                Intent intentTTSyule = new Intent(this, TTSYULEActivity.class);
                startActivity(intentTTSyule);
                menuPopupWindow.dismiss();
                break;
        }
    }
