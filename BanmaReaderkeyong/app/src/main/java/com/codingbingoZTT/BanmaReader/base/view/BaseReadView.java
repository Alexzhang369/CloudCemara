...
public abstract class BaseReadView extends View {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        switch (e.getAction()) {
                ...
                postInvalidate();
                ZTTLogUtils.e("fanye---actiondownX","actiondownX------------------"+actiondownX);
                ZTTLogUtils.e("fanye---mTouch.x","mTouch.x------------------"+mTouch.x);
                ZTTLogUtils.e("fanye---actiondownY","actiondownY------------------"+actiondownY);
                ZTTLogUtils.e("fanye---mTouch.y","mTouch.y------------------"+mTouch.y);
                ZTTLogUtils.e("fanye---right","right------------------"+right);
                ZTTLogUtils.e("fanye---left","left------------------"+left);
//                if(right) {
//                    //nextPage();
//                    prePage();
//                }
...
////                        for(int jump=0;jump<(y1 - y2)%100;jump++ ) {
////                            prePage();
////                        }
//                    } else if(y2 - y1 > 50) {
...
////                        for(int jump=0;jump<( y2-y1)%100;jump++ ) {
////                            nextPage();
////                        }
//                    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(y1 - y3 > 100) {
                    //Toast.makeText(MainActivity.this, "向上滑", Toast.LENGTH_SHORT).show(); 上
                    ZTTLogUtils.e("向上滑","向上滑---------y1-y2---------"+ String.valueOf(y1-y3));
                    ZTTLogUtils.e("向上滑", "向上滑---------x1-x2---------" + String.valueOf(x1 - x3));
                    for(int jump=0;jump<(y1 - y3)/200;jump++ ) {
                        prePage();
                    }
                } else{
                    prePage();
                ...
                if(y3 - y1 > 100) {
                    //Toast.makeText(MainActivity.this, "向下滑", Toast.LENGTH_SHORT).show(); 下
                    ZTTLogUtils.e("向下滑","向下滑---------y2 - y1---------"+String.valueOf(y3-y1));
                    ZTTLogUtils.e("向下滑", "向下滑---------x2 - x1 ---------" + String.valueOf(x3 - x1));
                    for(int jump=0;jump<( y3-y1)/200;jump++ ) {
                        nextPage();
                    }
