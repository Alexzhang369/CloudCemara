...
import zttokhttp.util.DateUtils;
import zttokhttp.util.MediaScanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebview.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                //getExternalStorageDirectory()  "eBook"+number+
                ZTTOkHttp.get(getApplicationContext()).download(url,
                         "/storage/emulated/0/BetaClub/Temp/"+ "/txt_download", "eBook"+nameTitle+number+".txt",
                        new ZTTDownloadResponseHandler() {
                            @Override
                            public void onFinish(File download_file) {
                                ZTTLogUtils.e(TAG, "onFinish:" + download_file.getPath());
                                MediaScanner.get(getApplicationContext(),download_file);
